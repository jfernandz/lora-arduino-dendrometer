...
This is more or less, the definition of the IoT (Internet of Things) concept; according to \cite{IoTOverview} IoT concept comes from an earlier concept called M2M (Machine-to-Machine) communications. However, also according to \cite{IoTOverview} there is not an official definition for IoT concept, but according to \cite{IoTObjetives}
...
\subsubsection{Dragino shields/hats}
...
Like in the Introduction the most proper way to present this technical description is differencing between software and hardware parts. However, is still interesting to present a simple and general diagram for whole designed solution:
...
Nevertheless, there are important considerations about the said above, 
