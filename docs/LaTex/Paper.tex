...
\begin{itemize}
  \item In a first place the reader will need to create a new device for the \textbf{IoTagent-LoRaWAN}, this can be done performing a \cmd{POST} HTTP request whose body will include the necessary data to retrieve the TTN stack context data.
